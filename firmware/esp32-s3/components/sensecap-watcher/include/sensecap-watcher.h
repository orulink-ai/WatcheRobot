...
#define BSP_I2S_GPIO_CFG                                                                                               \
    {                                                                                                                  \
        .mclk = BSP_AUDIO_I2S_MCLK, .bclk = BSP_AUDIO_I2S_SCLK, .ws = BSP_AUDIO_I2S_LRCK, .dout = BSP_AUDIO_I2S_DOUT,  \
...
#define BSP_I2S_SLOT_CONFIG(bits_per_sample, mono_or_stereo)                                                           \
    {                                                                                                                  \
        .data_bit_width = bits_per_sample, .slot_bit_width = I2S_SLOT_BIT_WIDTH_AUTO, .slot_mode = mono_or_stereo,     \
        .slot_mask = I2S_STD_SLOT_BOTH, .ws_width = bits_per_sample, .ws_pol = false, .bit_shift = true,               \
...
#define BSP_I2S_DUPLEX_MONO_CFG(_sample_rate)                                                                          \
    {                                                                                                                  \
        ...
        .slot_cfg = BSP_I2S_SLOT_CONFIG(I2S_DATA_BIT_WIDTH_16BIT, I2S_SLOT_MODE_MONO), .gpio_cfg = BSP_I2S_GPIO_CFG,   \
    }
