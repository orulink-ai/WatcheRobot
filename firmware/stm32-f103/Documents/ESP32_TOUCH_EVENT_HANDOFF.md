...
本说明只记录 STM32 本轮交付状态和 ESP32 对接所需事实。协议字段、消息号和完整语义仍以 `Ro-In-AI/WatcheRobot-Firmware` 的 `firmware/integration_docs/STM32_UART_PROTOCOL.md` 为真源。
...
本轮已刷写 STM32 Debug 固件并在 `COM57 @ 115200` 观察到触摸事件：
